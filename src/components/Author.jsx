    ...
    >
      ...
      <div className="relative max-w-5xl pt-16 mx-auto sm:px-6">
        <div className="pt-px bg-slate-50 sm:rounded-6xl">
          <div className="relative mx-auto -mt-16 h-44 w-44 overflow-hidden rounded-full bg-black md:float-right md:h-64 md:w-64 md:[shape-outside:circle(40%)] lg:mr-20 lg:h-72 lg:w-72">
            <Image
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            ...
            <p className="mt-8 text-5xl font-extrabold tracking-tight font-display text-slate-900 sm:text-6xl">
              <span className="block text-[#E91C8F]">Mira Lindehoff –</span> Hey
              there, Welcome to Expectoo Academy.
            </p>
            ...
            <p className="mt-8">
              ...
              >
                ...
                <span className="ml-4 text-[#E91C8F]">Follow on Twitter</span>
              </Link>
            </p>
          </div>
        </div>
